...
public final class SettingsActivityBinding implements ViewBinding {
  ...
  private SettingsActivityBinding(@NonNull ConstraintLayout rootView, @NonNull Toolbar myToolbar,
  ...
  public static SettingsActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SettingsActivityBinding((ConstraintLayout) rootView, myToolbar, settings);
    }
