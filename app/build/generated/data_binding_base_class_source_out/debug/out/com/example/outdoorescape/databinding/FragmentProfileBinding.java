...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton btnSettings, @NonNull ConstraintLayout constraintLayout,
      @NonNull CardView cvProfilePicture, @NonNull TextView nameTextView,
      @NonNull TextView nameTextView2, @NonNull ImageView profileImageView,
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((ConstraintLayout) rootView, btnSettings, constraintLayout,
          cvProfilePicture, nameTextView, nameTextView2, profileImageView, recyclerView);
    }
