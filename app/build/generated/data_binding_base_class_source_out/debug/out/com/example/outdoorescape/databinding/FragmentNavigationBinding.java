...
public final class FragmentNavigationBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnNavigationStart;
  ...
  private FragmentNavigationBinding(@NonNull ConstraintLayout rootView, @NonNull View SplitLineHor1,
      @NonNull View SplitLineHor2, @NonNull View SplitLineVer1, @NonNull View SplitLineVer2,
      @NonNull Button btnNavigationStart, @NonNull ConstraintLayout clAvgPace,
      @NonNull ConstraintLayout clCalories, @NonNull ConstraintLayout clDistance,
      @NonNull ConstraintLayout clDuration, @NonNull ConstraintLayout clStats,
      @NonNull ConstraintLayout clSteps, @NonNull Guideline guideline1,
      @NonNull Guideline guideline2, @NonNull Guideline guideline3, @NonNull Guideline guideline4,
      @NonNull Guideline guideline5, @NonNull CoordinatorLayout myCoordinatorLayout,
      @NonNull TextView tvAvgPace, @NonNull TextView tvAvgPageUnit,
      @NonNull TextView tvAvgPageValue, @NonNull TextView tvCalories,
      @NonNull TextView tvCaloriesUnit, @NonNull TextView tvCaloriesValue,
      @NonNull TextView tvDistance, @NonNull TextView tvDistanceUnit,
      @NonNull TextView tvDistanceValue, @NonNull TextView tvDuration,
      @NonNull TextView tvDurationValue, @NonNull TextView tvSteps,
    ...
    this.btnNavigationStart = btnNavigationStart;
  ...
  public static FragmentNavigationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnNavigationStart;
      Button btnNavigationStart = ViewBindings.findChildViewById(rootView, id);
      if (btnNavigationStart == null) {
        break missingId;
      }
      ...
      return new FragmentNavigationBinding((ConstraintLayout) rootView, SplitLineHor1,
          SplitLineHor2, SplitLineVer1, SplitLineVer2, btnNavigationStart, clAvgPace, clCalories,
